...
constant_contributions = np.load("./ProjectLib/ExampleSetups/ogs_example_setup/constant_contributions.npy")
salinity_prefactors = np.load("./ProjectLib/ExampleSetups/ogs_example_setup/salinity_prefactors.npy")
